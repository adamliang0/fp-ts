...
var external_NonEmptyArray_js_namespaceObject = require("./NonEmptyArray.js");
var external_ReadonlyArray_js_namespaceObject = require("./ReadonlyArray.js");
...
var isNonEmpty = external_NonEmptyArray_js_namespaceObject.isNonEmpty;
var prepend = external_NonEmptyArray_js_namespaceObject.prepend;
var prependW = external_NonEmptyArray_js_namespaceObject.prependW;
var append = external_NonEmptyArray_js_namespaceObject.append;
var appendW = external_NonEmptyArray_js_namespaceObject.appendW;
var makeBy = function(n, f) {
    return n <= 0 ? [] : external_NonEmptyArray_js_namespaceObject.makeBy(f)(n);
};
...
var fromOption = function(ma) {
    return external_internal_js_namespaceObject.isNone(ma) ? [] : [
        ma.value
    ];
};
var fromEither = function(e) {
    return external_internal_js_namespaceObject.isLeft(e) ? [] : [
        e.right
    ];
};
...
var matchLeftW = function(onEmpty, onNonEmpty) {
    return function(as) {
        return isNonEmpty(as) ? onNonEmpty(external_NonEmptyArray_js_namespaceObject.head(as), external_NonEmptyArray_js_namespaceObject.tail(as)) : onEmpty();
    };
};
...
var matchRightW = function(onEmpty, onNonEmpty) {
    return function(as) {
        return isNonEmpty(as) ? onNonEmpty(external_NonEmptyArray_js_namespaceObject.init(as), external_NonEmptyArray_js_namespaceObject.last(as)) : onEmpty();
    };
};
...
var scanLeft = function(b, f) {
    return function(as) {
        ...
        out[0] = b;
        for(var i = 0; i < len; i++)out[i + 1] = f(out[i], as[i]);
        return out;
    };
};
var scanRight = function(b, f) {
    return function(as) {
        ...
        out[len] = b;
        for(var i = len - 1; i >= 0; i--)out[i] = f(as[i], out[i + 1]);
        return out;
    };
};
...
var isOutOfBound = external_NonEmptyArray_js_namespaceObject.isOutOfBound;
var lookup = external_ReadonlyArray_js_namespaceObject.lookup;
var head = external_ReadonlyArray_js_namespaceObject.head;
var last = external_ReadonlyArray_js_namespaceObject.last;
var tail = function(as) {
    return isNonEmpty(as) ? external_internal_js_namespaceObject.some(external_NonEmptyArray_js_namespaceObject.tail(as)) : external_internal_js_namespaceObject.none;
};
var Array_init = function(as) {
    return isNonEmpty(as) ? external_internal_js_namespaceObject.some(external_NonEmptyArray_js_namespaceObject.init(as)) : external_internal_js_namespaceObject.none;
};
...
var takeRight = function(n) {
    return function(as) {
        return isOutOfBound(n, as) ? copy(as) : 0 === n ? [] : as.slice(-n);
    };
};
...
function spanLeft(predicate) {
    return function(as) {
        var _splitAt = _sliced_to_array(splitAt(spanLeftIndex(as, predicate))(as), 2), init = _splitAt[0], rest = _splitAt[1];
        return {
            init: init,
            rest: rest
        };
...
var findIndex = external_ReadonlyArray_js_namespaceObject.findIndex;
function findFirst(predicate) {
    return external_ReadonlyArray_js_namespaceObject.findFirst(predicate);
}
var findFirstMap = external_ReadonlyArray_js_namespaceObject.findFirstMap;
function findLast(predicate) {
    return external_ReadonlyArray_js_namespaceObject.findLast(predicate);
}
var findLastMap = external_ReadonlyArray_js_namespaceObject.findLastMap;
var findLastIndex = external_ReadonlyArray_js_namespaceObject.findLastIndex;
...
var deleteAt = function(i) {
    return function(as) {
        return isOutOfBound(i, as) ? external_internal_js_namespaceObject.none : external_internal_js_namespaceObject.some(unsafeDeleteAt(i, as));
    };
};
...
var zipWith = function(fa, fb, f) {
    ...
    for(var i = 0; i < len; i++)fc[i] = f(fa[i], fb[i]);
    return fc;
};
function zip(as, bs) {
...
var prependAll = function(middle) {
    var f = external_NonEmptyArray_js_namespaceObject.prependAll(middle);
    return function(as) {
        return isNonEmpty(as) ? f(as) : [];
    };
};
var intersperse = function(middle) {
    var f = external_NonEmptyArray_js_namespaceObject.intersperse(middle);
    return function(as) {
        return isNonEmpty(as) ? f(as) : copy(as);
    };
};
var rotate = function(n) {
    var f = external_NonEmptyArray_js_namespaceObject.rotate(n);
    return function(as) {
        return isNonEmpty(as) ? f(as) : copy(as);
    };
};
var elem = external_ReadonlyArray_js_namespaceObject.elem;
var uniq = function(E) {
    var f = external_NonEmptyArray_js_namespaceObject.uniq(E);
    return function(as) {
        return isNonEmpty(as) ? f(as) : copy(as);
    };
};
var sortBy = function(ords) {
    var f = external_NonEmptyArray_js_namespaceObject.sortBy(ords);
    return function(as) {
        return isNonEmpty(as) ? f(as) : copy(as);
    };
};
var chop = function(f) {
    var g = external_NonEmptyArray_js_namespaceObject.chop(f);
    return function(as) {
...
var splitAt = function(n) {
    return function(as) {
        return n >= 1 && isNonEmpty(as) ? external_NonEmptyArray_js_namespaceObject.splitAt(n)(as) : isEmpty(as) ? [
            copy(as),
            []
        ] : [
            [],
...
var chunksOf = function(n) {
    var f = external_NonEmptyArray_js_namespaceObject.chunksOf(n);
    return function(as) {
        return isNonEmpty(as) ? f(as) : [];
    };
};
var fromOptionK = function(f) {
    return function() {
        ...
        return fromOption(f.apply(void 0, _to_consumable_array(a)));
    };
};
function comprehension(input, f) {
    var g = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : function() {
        return true;
    };
    var go = function(scope, input) {
        return isNonEmpty(input) ? flatMap(external_NonEmptyArray_js_namespaceObject.head(input), function(a) {
            return go((0, external_function_js_namespaceObject.pipe)(scope, append(a)), external_NonEmptyArray_js_namespaceObject.tail(input));
        }) : g.apply(void 0, _to_consumable_array(scope)) ? [
            f.apply(void 0, _to_consumable_array(scope))
        ] : [];
    };
    return go([], input);
}
...
var concat = concatW;
function union(E) {
    var unionE = external_NonEmptyArray_js_namespaceObject.union(E);
    return function(first, second) {
        if (void 0 === second) {
            var unionE1 = union(E);
            return function(second) {
                return unionE1(second, first);
            };
        }
...
var _partitionWithIndex = function(fa, predicateWithIndex) {
    return (0, external_function_js_namespaceObject.pipe)(fa, partitionWithIndex(predicateWithIndex));
};
...
var _filterWithIndex = function(fa, predicateWithIndex) {
    return (0, external_function_js_namespaceObject.pipe)(fa, filterWithIndex(predicateWithIndex));
};
var _extend = function(fa, f) {
    return (0, external_function_js_namespaceObject.pipe)(fa, extend(f));
};
...
var _chainRecDepthFirst = external_ReadonlyArray_js_namespaceObject._chainRecDepthFirst;
var _chainRecBreadthFirst = external_ReadonlyArray_js_namespaceObject._chainRecBreadthFirst;
var of = external_NonEmptyArray_js_namespaceObject.of;
var zero = function() {
    return [];
};
var map = function(f) {
...
var filterMapWithIndex = function(f) {
    return function(fa) {
        ...
        for(var i = 0; i < fa.length; i++){
            ...
            if (external_internal_js_namespaceObject.isSome(optionB)) out.push(optionB.value);
        }
        return out;
    };
};
...
var compact = /*#__PURE__*/ filterMap(external_function_js_namespaceObject.identity);
...
var foldMap = external_ReadonlyArray_js_namespaceObject.foldMap;
var foldMapWithIndex = external_ReadonlyArray_js_namespaceObject.foldMapWithIndex;
var reduce = external_ReadonlyArray_js_namespaceObject.reduce;
var reduceWithIndex = external_ReadonlyArray_js_namespaceObject.reduceWithIndex;
var reduceRight = external_ReadonlyArray_js_namespaceObject.reduceRight;
var reduceRightWithIndex = external_ReadonlyArray_js_namespaceObject.reduceRightWithIndex;
    ...
    return function(ta) {
        return _reduce(ta, F.of(zero()), function(fas, fa) {
            return F.ap(F.map(fas, function(as) {
                return function(a) {
                    return (0, external_function_js_namespaceObject.pipe)(as, append(a));
                };
            }), fa);
        });
    };
...
var unfold = function(b, f) {
    ...
    while(true){
        var mt = f(bb);
        if (external_internal_js_namespaceObject.isSome(mt)) {
            var _mt_value = _sliced_to_array(mt.value, 2), a = _mt_value[0], _$b = _mt_value[1];
            out.push(a);
            bb = _$b;
        } else break;
    }
...
var URI = 'Array';
var getShow = external_ReadonlyArray_js_namespaceObject.getShow;
...
var getEq = external_ReadonlyArray_js_namespaceObject.getEq;
var getOrd = external_ReadonlyArray_js_namespaceObject.getOrd;
...
var chainRecDepthFirst = external_ReadonlyArray_js_namespaceObject.chainRecDepthFirst;
...
var chainRecBreadthFirst = external_ReadonlyArray_js_namespaceObject.chainRecBreadthFirst;
...
var filterE = /*#__PURE__*/ (0, external_Witherable_js_namespaceObject.filterE)(Witherable);
var FromEither = {
    URI: URI,
    fromEither: fromEither
};
var fromEitherK = /*#__PURE__*/ (0, external_FromEither_js_namespaceObject.fromEitherK)(FromEither);
var unsafeInsertAt = external_NonEmptyArray_js_namespaceObject.unsafeInsertAt;
var unsafeUpdateAt = function(i, a, as) {
    return isNonEmpty(as) ? external_NonEmptyArray_js_namespaceObject.unsafeUpdateAt(i, a, as) : [];
};
...
var every = external_ReadonlyArray_js_namespaceObject.every;
...
var exists = some;
var intercalate = external_ReadonlyArray_js_namespaceObject.intercalate;
...
var chain = flatMap;
var range = external_NonEmptyArray_js_namespaceObject.range;
var empty = [];
var cons = external_NonEmptyArray_js_namespaceObject.cons;
var snoc = external_NonEmptyArray_js_namespaceObject.snoc;
...
exports.ChainRecBreadthFirst = __webpack_exports__.ChainRecBreadthFirst;
exports.ChainRecDepthFirst = __webpack_exports__.ChainRecDepthFirst;
...
exports.Unfoldable = __webpack_exports__.Unfoldable;
...
exports.comprehension = __webpack_exports__.comprehension;
...
exports.dropLeft = __webpack_exports__.dropLeft;
exports.dropLeftWhile = __webpack_exports__.dropLeftWhile;
exports.dropRight = __webpack_exports__.dropRight;
...
exports.findFirst = __webpack_exports__.findFirst;
exports.findFirstMap = __webpack_exports__.findFirstMap;
exports.findIndex = __webpack_exports__.findIndex;
exports.findLast = __webpack_exports__.findLast;
exports.findLastIndex = __webpack_exports__.findLastIndex;
exports.findLastMap = __webpack_exports__.findLastMap;
...
exports.lefts = __webpack_exports__.lefts;
...
exports.matchLeftW = __webpack_exports__.matchLeftW;
exports.matchRight = __webpack_exports__.matchRight;
exports.matchRightW = __webpack_exports__.matchRightW;
...
exports.rights = __webpack_exports__.rights;
exports.rotate = __webpack_exports__.rotate;
exports.scanLeft = __webpack_exports__.scanLeft;
exports.scanRight = __webpack_exports__.scanRight;
...
exports.spanLeft = __webpack_exports__.spanLeft;
exports.splitAt = __webpack_exports__.splitAt;
exports.tail = __webpack_exports__.tail;
exports.takeLeft = __webpack_exports__.takeLeft;
exports.takeLeftWhile = __webpack_exports__.takeLeftWhile;
exports.takeRight = __webpack_exports__.takeRight;
exports.traverse = __webpack_exports__.traverse;
exports.traverseWithIndex = __webpack_exports__.traverseWithIndex;
exports.unfold = __webpack_exports__.unfold;
exports.union = __webpack_exports__.union;
exports.uniq = __webpack_exports__.uniq;
exports.unsafeDeleteAt = __webpack_exports__.unsafeDeleteAt;
