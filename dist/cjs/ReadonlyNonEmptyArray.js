...
__webpack_require__.d(__webpack_exports__, {
    ...
    readonlyNonEmptyArray: function() {
        return readonlyNonEmptyArray;
    },
    range: function() {
        return range;
    },
    ...
    init: function() {
        return ReadonlyNonEmptyArray_init;
    },
    chain: function() {
        return chain;
    },
    ...
    head: function() {
        return ReadonlyNonEmptyArray_head;
    },
    bindTo: function() {
        return bindTo;
    },
    ...
    tail: function() {
        return ReadonlyNonEmptyArray_tail;
    },
    empty: function() {
        return empty;
    },
...
var empty = external_internal_js_namespaceObject.emptyReadonlyArray;
var isNonEmpty = external_internal_js_namespaceObject.isNonEmpty;
...
var unsafeInsertAt = function(i, a, as) {
    if (isNonEmpty(as)) {
        var xs = external_internal_js_namespaceObject.fromReadonlyNonEmptyArray(as);
        xs.splice(i, 0, a);
        return xs;
    }
    return [
...
var uniq = function(E) {
    return function(as) {
        ...
        var rest = ReadonlyNonEmptyArray_tail(as);
...
var sort = function(O) {
    return function(as) {
        return 1 === as.length ? as : as.slice().sort(O.compare);
    };
};
...
var intersperse = function(middle) {
    return function(as) {
        var rest = ReadonlyNonEmptyArray_tail(as);
        return isNonEmpty(rest) ? (0, external_function_js_namespaceObject.pipe)(rest, prependAll(middle), prepend(ReadonlyNonEmptyArray_head(as))) : as;
    };
};
var chainWithIndex = function(f) {
    return function(as) {
        var out = external_internal_js_namespaceObject.fromReadonlyNonEmptyArray(f(0, ReadonlyNonEmptyArray_head(as)));
...
var splitAt = function(n) {
    return function(as) {
        ...
        return m >= as.length ? [
            ...
            (0, external_function_js_namespaceObject.pipe)(as.slice(1, m), prepend(ReadonlyNonEmptyArray_head(as))),
            as.slice(m)
        ];
    };
};
...
var of = external_internal_js_namespaceObject.singleton;
...
var extend = function(f) {
    return function(as) {
        var next = ReadonlyNonEmptyArray_tail(as);
        var out = [
            f(as)
        ];
        while(isNonEmpty(next)){
...
var sequence = function(F) {
    return traverseWithIndex(F)(external_function_js_namespaceObject.SK);
};
var traverseWithIndex = function(F) {
    return function(f) {
        return function(as) {
            var out = F.map(f(0, ReadonlyNonEmptyArray_head(as)), of);
...
var extract = external_internal_js_namespaceObject.head;
...
var getEq = function(E) {
    return (0, external_Eq_js_namespaceObject.fromEquals)(function(xs, ys) {
...
var ReadonlyNonEmptyArray_head = extract;
var ReadonlyNonEmptyArray_tail = external_internal_js_namespaceObject.tail;
var last = function(as) {
    return as[as.length - 1];
};
var ReadonlyNonEmptyArray_init = function(as) {
    return as.slice(0, -1);
};
var min = function(O) {
    var S = external_Semigroup_js_namespaceObject.min(O);
    return function(as) {
        return as.reduce(S.concat);
    };
};
var max = function(O) {
    var S = external_Semigroup_js_namespaceObject.max(O);
    return function(as) {
        return as.reduce(S.concat);
    };
};
...
var matchLeft = function(f) {
    return function(as) {
        return f(ReadonlyNonEmptyArray_head(as), ReadonlyNonEmptyArray_tail(as));
    };
};
var matchRight = function(f) {
    return function(as) {
        return f(ReadonlyNonEmptyArray_init(as), last(as));
    };
};
var modifyHead = function(f) {
    return function(as) {
        ...
        ].concat(_to_consumable_array(ReadonlyNonEmptyArray_tail(as)));
    };
};
...
var modifyLast = function(f) {
    return function(as) {
        return (0, external_function_js_namespaceObject.pipe)(ReadonlyNonEmptyArray_init(as), append(f(last(as))));
    };
};
...
var intercalate = function(S) {
    ...
    return function(middle) {
        return (0, external_function_js_namespaceObject.flow)(intersperse(middle), concatAllS);
    };
};
var chain = flatMap;
...
var snoc = function(init, end) {
    return (0, external_function_js_namespaceObject.pipe)(init, concat([
        end
    ]));
};
...
exports.readonlyNonEmptyArray = __webpack_exports__.readonlyNonEmptyArray;
