 ...
 * @since 2.11.0
 */
export declare const sortBy: <B>(ords: ReadonlyArray<Ord<B>>) => (<A extends B>(as: ReadonlyNonEmptyArray<A>) => ReadonlyNonEmptyArray<A>);
/**
 * @since 2.11.0
 */
 ...
 * @since 2.5.0
 */
export declare const groupBy: <A>(f: (a: A) => string) => (as: ReadonlyArray<A>) => ReadonlyRecord<string, ReadonlyNonEmptyArray<A>>;
/**
 * @since 2.5.0
 */
 ...
 * @since 2.10.0
 */
export declare const chop: <A, B>(f: (as: ReadonlyNonEmptyArray<A>) => readonly [B, ReadonlyArray<A>]) => (as: ReadonlyNonEmptyArray<A>) => ReadonlyNonEmptyArray<B>;
/**
 * Splits a `ReadonlyNonEmptyArray` into two pieces, the first piece has max `n` elements.
 *
 * @since 2.10.0
 */
export declare const splitAt: (n: number) => <A>(as: ReadonlyNonEmptyArray<A>) => readonly [ReadonlyNonEmptyArray<A>, ReadonlyArray<A>];
/**
 ...
 * @since 2.9.0
 */
export declare const altW: <B>(that: LazyArg<ReadonlyNonEmptyArray<B>>) => <A>(as: ReadonlyNonEmptyArray<A>) => ReadonlyNonEmptyArray<A | B>;
/**
 ...
 * @since 2.6.2
 */
export declare const alt: <A>(that: LazyArg<ReadonlyNonEmptyArray<A>>) => (as: ReadonlyNonEmptyArray<A>) => ReadonlyNonEmptyArray<A>;
/**
 * @since 2.5.0
 */
 ...
 * @since 2.5.0
 */
export declare const foldMapWithIndex: <S>(S: Semigroup<S>) => <A>(f: (i: number, a: A) => S) => (as: ReadonlyNonEmptyArray<A>) => S;
/**
 * @category folding
 * @since 2.5.0
 */
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => (fa: ReadonlyNonEmptyArray<A>) => ReadonlyNonEmptyArray<{ readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const matchRight: <A, B>(f: (init: ReadonlyArray<A>, last: A) => B) => (as: ReadonlyNonEmptyArray<A>) => B;
/**
