 ...
 * @since 2.10.0
 */
export declare const struct: <A>(semigroups: { [K in keyof A]: Semigroup<A[K]>; }) => Semigroup<{ readonly [K in keyof A]: A[K]; }>;
/**
 ...
 * @since 2.10.0
 */
export declare const tuple: <A extends ReadonlyArray<unknown>>(...semigroups: { [K in keyof A]: Semigroup<A[K]>; }) => Semigroup<Readonly<A>>;
/**
