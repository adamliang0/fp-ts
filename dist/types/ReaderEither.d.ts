 ...
 * @since 2.0.0
 */
export declare const fold: <R, E, A, B>(onLeft: (e: E) => Reader<R, B>, onRight: (a: A) => Reader<R, B>) => (ma: ReaderEither<R, E, A>) => Reader<R, B>;
/**
 ...
 * @since 2.10.0
 */
export declare const foldW: <E, R2, B, A, R3, C>(onLeft: (e: E) => Reader<R2, B>, onRight: (a: A) => Reader<R3, C>) => <R1>(ma: ReaderEither<R1, E, A>) => Reader<R1 & R2 & R3, B | C>;
/**
 ...
 * @since 2.16.6
 */
export declare const orLeftW: <E1, R2, E2>(onLeft: (e: E1) => Reader<R2, E2>) => <R1, A>(fa: ReaderEither<R1, E1, A>) => ReaderEither<R1 & R2, E2, A>;
/**
 * @since 2.0.0
 */
 ...
 * @since 2.12.0
 */
export declare const apFirstW: <R2, E2, B>(second: ReaderEither<R2, E2, B>) => <R1, E1, A>(first: ReaderEither<R1, E1, A>) => ReaderEither<R1 & R2, E1 | E2, A>;
/**
 ...
 * @since 2.12.0
 */
export declare const apSecondW: <R2, E2, B>(second: ReaderEither<R2, E2, B>) => <R1, E1, A>(first: ReaderEither<R1, E1, A>) => ReaderEither<R1 & R2, E1 | E2, B>;
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.11.0
 */
export declare const chainFirstReaderK: <A, R, B>(f: (a: A) => Reader<R, B>) => <E>(ma: ReaderEither<R, E, A>) => ReaderEither<R, E, A>;
/**
 * Alias of `tapReader`.
 *
 ...
 * @since 2.11.0
 */
export declare const chainFirstReaderKW: <A, R1, B>(f: (a: A) => Reader<R1, B>) => <R2, E>(ma: ReaderEither<R2, E, A>) => ReaderEither<R1 & R2, E, A>;
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromOptionK: <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => <R = unknown>(...a: A) => ReaderEither<R, E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.10.0
 */
export declare const chainOptionK: <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => <R>(ma: ReaderEither<R, E, A>) => ReaderEither<R, E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.13.2
 */
export declare const chainOptionKW: <E2>(onNone: LazyArg<E2>) => <A, B>(f: (a: A) => Option<B>) => <R, E1>(ma: ReaderEither<R, E1, A>) => ReaderEither<R, E1 | E2, B>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftNullable: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => B | null | undefined, onNullable: (...a: A) => E) => <R>(...a: A) => ReaderEither<R, E, NonNullable<B>>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftOption: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => Option<B>, onNone: (...a: A) => E) => <R>(...a: A) => ReaderEither<R, E, B>;
/**
 * @category sequencing
 * @since 2.15.0
 */
...
export declare const flatMapOption: {
    <A, B, E2>(f: (a: A) => Option<B>, onNone: (a: A) => E2): <R, E1>(self: ReaderEither<R, E1, A>) => ReaderEither<R, E2 | E1, B>;
    <R, E1, A, B, E2>(self: ReaderEither<R, E1, A>, f: (a: A) => Option<B>, onNone: (a: A) => E2): ReaderEither<R, E1 | E2, B>;
};
/**
 * @category sequencing
 * @since 2.15.0
 ...
 * @since 2.12.0
 */
export declare const chainFirstEitherK: <A, E, B>(f: (a: A) => E.Either<E, B>) => <R>(ma: ReaderEither<R, E, A>) => ReaderEither<R, E, A>;
/**
 * Alias of `tapEither`.
 *
 ...
 * @since 2.12.0
 */
export declare const chainFirstEitherKW: <A, E2, B>(f: (a: A) => Either<E2, B>) => <R, E1>(ma: ReaderEither<R, E1, A>) => ReaderEither<R, E1 | E2, A>;
/**
 ...
 * @since 2.11.0
 */
export declare const chainReaderK: <A, R, B>(f: (a: A) => Reader<R, B>) => <E>(ma: ReaderEither<R, E, A>) => ReaderEither<R, E, B>;
/**
 * Alias of `flatMapReader`.
 *
 * Less strict version of [`chainReaderK`](#chainreaderk).
 ...
 * @since 2.11.0
 */
export declare const chainReaderKW: <A, R2, B>(f: (a: A) => Reader<R2, B>) => <R1, E>(ma: ReaderEither<R1, E, A>) => ReaderEither<R1 & R2, E, B>;
/**
 * @category lifting
 * @since 2.0.0
 */
 ...
 * @since 2.4.0
 */
export declare const fromEitherK: <E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => E.Either<E, B>) => <R = unknown>(...a: A) => ReaderEither<R, E, B>;
/**
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => <R, E>(fa: ReaderEither<R, E, A>) => ReaderEither<R, E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, R, E, B>(f: (index: number, a: A) => ReaderEither<R, E, B>) => ((as: ReadonlyArray<A>) => ReaderEither<R, E, ReadonlyArray<B>>);
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(Applicative)`.
 *
 * @category traversing
 ...
 * @since 2.9.0
 */
export declare const traverseArray: <R, E, A, B>(f: (a: A) => ReaderEither<R, E, B>) => ((as: ReadonlyArray<A>) => ReaderEither<R, E, ReadonlyArray<B>>);
/**
