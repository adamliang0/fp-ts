 ...
 * @since 2.0.0
 */
export declare function intercalate<M, F extends URIS3>(M: Monoid<M>, F: Foldable3<F>): <R, E>(middle: M, fm: Kind3<F, R, E, M>) => M;
export declare function intercalate<M, F extends URIS2>(M: Monoid<M>, F: Foldable2<F>): <E>(middle: M, fm: Kind2<F, E, M>) => M;
export declare function intercalate<M, F extends URIS2, E>(M: Monoid<M>, F: Foldable2C<F, E>): (middle: M, fm: Kind2<F, E, M>) => M;
