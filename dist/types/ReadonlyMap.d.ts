 ...
 * @since 2.5.0
 */
export declare const modifyAt: <K>(E: Eq<K>) => (<A>(k: K, f: (a: A) => A) => (m: ReadonlyMap<K, A>) => Option<ReadonlyMap<K, A>>);
/**
 ...
 * @since 2.10.0
 */
export declare const filterMapWithIndex: <K, A, B>(f: (k: K, a: A) => Option<B>) => (fa: ReadonlyMap<K, A>) => ReadonlyMap<K, B>;
/**
 * @since 2.10.0
 */
