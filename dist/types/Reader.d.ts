...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => <E>(fa: Reader<E, A>) => Reader<E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, R, B>(f: (index: number, a: A) => Reader<R, B>) => ((as: ReadonlyArray<A>) => Reader<R, ReadonlyArray<B>>);
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(Applicative)`.
 *
 * @category traversing
 ...
 * @since 2.9.0
 */
export declare const traverseArray: <R, A, B>(f: (a: A) => Reader<R, B>) => ((as: ReadonlyArray<A>) => Reader<R, ReadonlyArray<B>>);
/**
