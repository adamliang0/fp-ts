 ...
 * @since 2.10.0
 */
export declare const foldW: <E, B, A, C>(onLeft: (e: E) => IO<B>, onRight: (a: A) => IO<C>) => (ma: IOEither<E, A>) => IO<B | C>;
/**
 ...
 * @since 2.10.0
 */
export declare const tryCatchK: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => B, onThrow: (reason: unknown) => E) => ((...a: A) => IOEither<E, B>);
/**
 * @category conversions
 * @since 2.10.0
 */
 ...
 * @since 2.9.0
 */
export declare const altW: <E2, B>(that: LazyArg<IOEither<E2, B>>) => <E1, A>(fa: IOEither<E1, A>) => IOEither<E2, A | B>;
/**
 * @since 2.7.0
 */
 ...
 * @since 2.12.0
 */
export declare const apFirstW: <E2, B>(second: IOEither<E2, B>) => <E1, A>(first: IOEither<E1, A>) => IOEither<E1 | E2, A>;
/**
 ...
 * @since 2.12.0
 */
export declare const apSecondW: <E2, B>(second: IOEither<E2, B>) => <E1, A>(first: IOEither<E1, A>) => IOEither<E1 | E2, B>;
/**
 * Runs computations in parallel.
 *
 * @category instances
 ...
 * @since 2.10.0
 */
export declare const fromIOK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => I.IO<B>) => <E = never>(...a: A) => IOEither<E, B>;
/**
 * Alias of `tapIO`.
 *
 * @category legacy
 ...
 * @since 2.10.0
 */
export declare const fromOptionK: <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => IOEither<E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.10.0
 */
export declare const chainOptionK: <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => (ma: IOEither<E, A>) => IOEither<E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.13.2
 */
export declare const chainOptionKW: <E2>(onNone: LazyArg<E2>) => <A, B>(f: (a: A) => Option<B>) => <E1>(ma: IOEither<E1, A>) => IOEither<E1 | E2, B>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftNullable: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => B | null | undefined, onNullable: (...a: A) => E) => (...a: A) => IOEither<E, NonNullable<B>>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftOption: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => Option<B>, onNone: (...a: A) => E) => (...a: A) => IOEither<E, B>;
/**
 * @category sequencing
 * @since 2.15.0
 */
 ...
 * @since 2.12.0
 */
export declare const chainFirstEitherKW: <A, E2, B>(f: (a: A) => E.Either<E2, B>) => <E1>(ma: IOEither<E1, A>) => IOEither<E1 | E2, A>;
/**
 * @category lifting
 * @since 2.0.0
 */
 ...
 * @since 2.0.0
 */
export declare const bracket: <E, A, B>(acquire: IOEither<E, A>, use: (a: A) => IOEither<E, B>, release: (a: A, e: Either<E, B>) => IOEither<E, void>) => IOEither<E, B>;
/**
 ...
 * @since 2.12.0
 */
export declare const bracketW: <E1, A, E2, B, E3>(acquire: IOEither<E1, A>, use: (a: A) => IOEither<E2, B>, release: (a: A, e: E.Either<E2, B>) => IOEither<E3, void>) => IOEither<E1 | E2 | E3, B>;
/**
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => <E>(fa: IOEither<E, A>) => IOEither<E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, E, B>(f: (index: number, a: A) => IOEither<E, B>) => ((as: ReadonlyArray<A>) => IOEither<E, ReadonlyArray<B>>);
/**
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndexSeq: <A, E, B>(f: (index: number, a: A) => IOEither<E, B>) => ((as: ReadonlyArray<A>) => IOEither<E, ReadonlyArray<B>>);
/**
 ...
 * @since 2.9.0
 */
export declare const traverseArray: <A, E, B>(f: (a: A) => IOEither<E, B>) => ((as: ReadonlyArray<A>) => IOEither<E, ReadonlyArray<B>>);
/**
 ...
 * @since 2.9.0
 */
export declare const traverseSeqArray: <A, E, B>(f: (a: A) => IOEither<E, B>) => ((as: ReadonlyArray<A>) => IOEither<E, ReadonlyArray<B>>);
/**
