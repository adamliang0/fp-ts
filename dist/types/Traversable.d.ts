 ...
 * @since 2.10.0
 */
export declare function traverse<T extends URIS, G extends URIS2>(T: Traversable1<T>, G: Traversable2<G>): {
 ...
 * @since 2.10.0
 */
export declare function sequence<T extends URIS, G extends URIS2>(T: Traversable1<T>, G: Traversable2<G>): {
