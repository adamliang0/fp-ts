 ...
 * @since 2.5.0
 */
export declare const updateAt: <A>(k: string, a: A) => <K extends string>(r: ReadonlyRecord<K, A>) => Option<ReadonlyRecord<K, A>>;
/**
 ...
 * @since 2.5.0
 */
export declare const modifyAt: <A>(k: string, f: (a: A) => A) => <K extends string>(r: ReadonlyRecord<K, A>) => Option<ReadonlyRecord<K, A>>;
/**
 ...
 * @since 2.5.0
 */
export declare function traverseWithIndex<F extends URIS4>(F: Applicative4<F>): <K extends string, S, R, E, A, B>(f: (k: K, a: A) => Kind4<F, S, R, E, B>) => (ta: ReadonlyRecord<K, A>) => Kind4<F, S, R, E, ReadonlyRecord<K, B>>;
 ...
 * @since 2.5.0
 */
export declare function traverse<F extends URIS4>(F: Applicative4<F>): <S, R, E, A, B>(f: (a: A) => Kind4<F, S, R, E, B>) => <K extends string>(ta: ReadonlyRecord<K, A>) => Kind4<F, S, R, E, ReadonlyRecord<K, B>>;
 ...
 * @since 2.5.0
 */
export declare function every<A, B extends A>(refinement: Refinement<A, B>): Refinement<ReadonlyRecord<string, A>, ReadonlyRecord<string, B>>;
 ...
 * @since 2.11.0
 */
export declare const union: <A>(M: Magma<A>) => (second: ReadonlyRecord<string, A>) => (first: ReadonlyRecord<string, A>) => ReadonlyRecord<string, A>;
/**
 ...
 * @since 2.11.0
 */
export declare const intersection: <A>(M: Magma<A>) => (second: ReadonlyRecord<string, A>) => (first: ReadonlyRecord<string, A>) => ReadonlyRecord<string, A>;
/**
 ...
 * @since 2.11.0
 */
export declare const difference: <A>(second: ReadonlyRecord<string, A>) => (first: ReadonlyRecord<string, A>) => ReadonlyRecord<string, A>;
/**
 ...
 * @since 2.5.0
 */
export declare const separate: <A, B>(r: ReadonlyRecord<string, Either<A, B>>) => Separated<ReadonlyRecord<string, A>, ReadonlyRecord<string, B>>;
/**
