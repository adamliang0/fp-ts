 ...
 * @since 2.10.0
 */
export declare function fromOption<F extends URIS4>(F: FromEither4<F>): <E>(onNone: LazyArg<E>) => <A, S, R>(fa: Option<A>) => Kind4<F, S, R, E, A>;
export declare function fromOption<F extends URIS3>(F: FromEither3<F>): <E>(onNone: LazyArg<E>) => <A, R>(fa: Option<A>) => Kind3<F, R, E, A>;
export declare function fromOption<F extends URIS3, E>(F: FromEither3C<F, E>): (onNone: LazyArg<E>) => <A, R>(fa: Option<A>) => Kind3<F, R, E, A>;
export declare function fromOption<F extends URIS2>(F: FromEither2<F>): <E>(onNone: LazyArg<E>) => <A>(fa: Option<A>) => Kind2<F, E, A>;
export declare function fromOption<F extends URIS2, E>(F: FromEither2C<F, E>): (onNone: LazyArg<E>) => <A>(fa: Option<A>) => Kind2<F, E, A>;
 ...
 * @since 2.10.0
 */
export declare function fromOptionK<F extends URIS4>(F: FromEither4<F>): <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => <S, R>(...a: A) => Kind4<F, S, R, E, B>;
export declare function fromOptionK<F extends URIS3>(F: FromEither3<F>): <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => <R>(...a: A) => Kind3<F, R, E, B>;
export declare function fromOptionK<F extends URIS3, E>(F: FromEither3C<F, E>): (onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => <R>(...a: A) => Kind3<F, R, E, B>;
export declare function fromOptionK<F extends URIS2>(F: FromEither2<F>): <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => Kind2<F, E, B>;
export declare function fromOptionK<F extends URIS2, E>(F: FromEither2C<F, E>): (onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => Kind2<F, E, B>;
export declare function fromOptionK<F>(F: FromEither<F>): <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => HKT2<F, E, B>;
/**
 * @since 2.10.0
 */
export declare function chainOptionK<F extends URIS4>(F: FromEither4<F>, M: Chain4<F>): <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => <S, R>(ma: Kind4<F, S, R, E, A>) => Kind4<F, S, R, E, B>;
export declare function chainOptionK<F extends URIS3>(F: FromEither3<F>, M: Chain3<F>): <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => <R>(ma: Kind3<F, R, E, A>) => Kind3<F, R, E, B>;
export declare function chainOptionK<F extends URIS3, E>(F: FromEither3C<F, E>, M: Chain3C<F, E>): (onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => <R>(ma: Kind3<F, R, E, A>) => Kind3<F, R, E, B>;
export declare function chainOptionK<F extends URIS2>(F: FromEither2<F>, M: Chain2<F>): <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => (ma: Kind2<F, E, A>) => Kind2<F, E, B>;
export declare function chainOptionK<F extends URIS2, E>(F: FromEither2C<F, E>, M: Chain2C<F, E>): (onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => (ma: Kind2<F, E, A>) => Kind2<F, E, B>;
export declare function chainOptionK<F>(F: FromEither<F>, M: Chain<F>): <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => (ma: HKT2<F, E, A>) => HKT2<F, E, B>;
/**
 * @since 2.10.0
 */
 ...
 * @since 2.12.0
 */
export declare function chainFirstEitherK<M extends URIS4>(F: FromEither4<M>, M: Chain4<M>): <A, E, B>(f: (a: A) => Either<E, B>) => <S, R>(ma: Kind4<M, S, R, E, A>) => Kind4<M, S, R, E, A>;
export declare function chainFirstEitherK<M extends URIS3>(F: FromEither3<M>, M: Chain3<M>): <A, E, B>(f: (a: A) => Either<E, B>) => <R>(ma: Kind3<M, R, E, A>) => Kind3<M, R, E, A>;
export declare function chainFirstEitherK<M extends URIS3, E>(F: FromEither3C<M, E>, M: Chain3C<M, E>): <A, B>(f: (a: A) => Either<E, B>) => <R>(ma: Kind3<M, R, E, A>) => Kind3<M, R, E, A>;
export declare function chainFirstEitherK<M extends URIS2>(F: FromEither2<M>, M: Chain2<M>): <A, E, B>(f: (a: A) => Either<E, B>) => (ma: Kind2<M, E, A>) => Kind2<M, E, A>;
export declare function chainFirstEitherK<M extends URIS2, E>(F: FromEither2C<M, E>, M: Chain2C<M, E>): <A, B>(f: (a: A) => Either<E, B>) => (ma: Kind2<M, E, A>) => Kind2<M, E, A>;
export declare function chainFirstEitherK<M extends URIS>(F: FromEither1<M>, M: Chain1<M>): <E, A, B>(f: (a: A) => Either<E, B>) => (ma: Kind<M, A>) => Kind<M, A>;
export declare function chainFirstEitherK<M>(F: FromEither<M>, M: Chain<M>): <A, E, B>(f: (a: A) => Either<E, B>) => (ma: HKT2<M, E, A>) => HKT2<M, E, A>;
/**
 * @since 2.10.0
 */
