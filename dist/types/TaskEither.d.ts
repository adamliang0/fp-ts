 ...
 * @since 2.0.0
 */
export declare const fold: <E, A, B>(onLeft: (e: E) => Task<B>, onRight: (a: A) => Task<B>) => (ma: TaskEither<E, A>) => Task<B>;
/**
 ...
 * @since 2.5.0
 */
export declare const tryCatchK: <E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Promise<B>, onRejected: (reason: unknown) => E) => ((...a: A) => TaskEither<E, B>);
/**
 * @category conversions
 * @since 2.10.0
 */
 ...
 * @since 2.12.0
 */
export declare const fromNullableK: <E>(e: E) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => B | null | undefined) => (...a: A) => TaskEither<E, NonNullable<B>>;
/**
 * Use `flatMapNullable`.
 *
 * @category legacy
 * @since 2.12.0
 */
export declare const chainNullableK: <E>(e: E) => <A, B>(f: (a: A) => B | null | undefined) => (ma: TaskEither<E, A>) => TaskEither<E, NonNullable<B>>;
/**
 ...
 * @since 2.12.0
 */
export declare const orElseFirstTaskK: <E, B>(onLeft: (e: E) => Task<B>) => <A>(ma: TaskEither<E, A>) => TaskEither<E, A>;
/**
 * @category error handling
 * @since 2.11.0
 */
 ...
 * @since 2.11.0
 */
export declare const fromTaskOptionK: <E>(onNone: LazyArg<E>) => (<A extends ReadonlyArray<unknown>, B>(f: (...a: A) => TaskOption<B>) => (...a: A) => TaskEither<E, B>);
/**
 ...
 * @since 2.12.3
 */
export declare const chainTaskOptionKW: <E2>(onNone: LazyArg<E2>) => <A, B>(f: (a: A) => TaskOption<B>) => <E1>(ma: TaskEither<E1, A>) => TaskEither<E1 | E2, B>;
/**
 * Use `flatMapTaskOption`.
 *
 * @category legacy
 * @since 2.11.0
 */
export declare const chainTaskOptionK: <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => TaskOption<B>) => (ma: TaskEither<E, A>) => TaskEither<E, B>;
/**
 * @category lifting
 * @since 2.4.0
 */
export declare const fromIOEitherK: <E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => IOEither<E, B>) => ((...a: A) => TaskEither<E, B>);
/**
 ...
 * @since 2.9.0
 */
export declare const altW: <E2, B>(that: LazyArg<TaskEither<E2, B>>) => <E1, A>(fa: TaskEither<E1, A>) => TaskEither<E2, A | B>;
/**
 * @category constructors
 * @since 2.0.0
 */
 ...
 * @since 2.12.0
 */
export declare const apFirstW: <E2, B>(second: TaskEither<E2, B>) => <E1, A>(first: TaskEither<E1, A>) => TaskEither<E1 | E2, A>;
/**
 ...
 * @since 2.12.0
 */
export declare const apSecondW: <E2, B>(second: TaskEither<E2, B>) => <E1, A>(first: TaskEither<E1, A>) => TaskEither<E1 | E2, B>;
/**
 * Runs computations in parallel.
 *
 * @category instances
 ...
 * @since 2.10.0
 */
export declare const fromOptionK: <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => TaskEither<E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.10.0
 */
export declare const chainOptionK: <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => (ma: TaskEither<E, A>) => TaskEither<E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.13.2
 */
export declare const chainOptionKW: <E2>(onNone: LazyArg<E2>) => <A, B>(f: (a: A) => Option<B>) => <E1>(ma: TaskEither<E1, A>) => TaskEither<E1 | E2, B>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftNullable: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => B | null | undefined, onNullable: (...a: A) => E) => (...a: A) => TaskEither<E, NonNullable<B>>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftOption: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => Option<B>, onNone: (...a: A) => E) => (...a: A) => TaskEither<E, B>;
/**
 * @category sequencing
 * @since 2.15.0
 */
 ...
 * @since 2.12.0
 */
export declare const chainFirstEitherK: <A, E, B>(f: (a: A) => E.Either<E, B>) => (ma: TaskEither<E, A>) => TaskEither<E, A>;
/**
 * Alias of `tapEither`.
 *
 ...
 * @since 2.12.0
 */
export declare const chainFirstEitherKW: <A, E2, B>(f: (a: A) => E.Either<E2, B>) => <E1>(ma: TaskEither<E1, A>) => TaskEither<E1 | E2, A>;
/**
 * @category lifting
 * @since 2.0.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromIOK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => IO<B>) => <E = never>(...a: A) => TaskEither<E, B>;
/**
 * Alias of `flatMapIO`.
 *
 * @category legacy
 ...
 * @since 2.10.0
 */
export declare const fromTaskK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => T.Task<B>) => <E = never>(...a: A) => TaskEither<E, B>;
/**
 ...
 * @since 2.0.0
 */
export declare const bracket: <E, A, B>(acquire: TaskEither<E, A>, use: (a: A) => TaskEither<E, B>, release: (a: A, e: Either<E, B>) => TaskEither<E, void>) => TaskEither<E, B>;
/**
 ...
 * @since 2.12.0
 */
export declare const bracketW: <E1, A, E2, B, E3>(acquire: TaskEither<E1, A>, use: (a: A) => TaskEither<E2, B>, release: (a: A, e: E.Either<E2, B>) => TaskEither<E3, void>) => TaskEither<E1 | E2 | E3, B>;
/**
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => <E>(fa: TaskEither<E, A>) => TaskEither<E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, E, B>(f: (index: number, a: A) => TaskEither<E, B>) => ((as: ReadonlyArray<A>) => TaskEither<E, ReadonlyArray<B>>);
/**
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndexSeq: <A, E, B>(f: (index: number, a: A) => TaskEither<E, B>) => ((as: ReadonlyArray<A>) => TaskEither<E, ReadonlyArray<B>>);
/**
 ...
 * @since 2.9.0
 */
export declare const traverseArray: <A, B, E>(f: (a: A) => TaskEither<E, B>) => ((as: ReadonlyArray<A>) => TaskEither<E, ReadonlyArray<B>>);
/**
 ...
 * @since 2.9.0
 */
export declare const traverseSeqArray: <A, B, E>(f: (a: A) => TaskEither<E, B>) => ((as: ReadonlyArray<A>) => TaskEither<E, ReadonlyArray<B>>);
/**
