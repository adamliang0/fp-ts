 ...
 * @since 2.0.0
 */
export declare const isEmpty: <A>(as: Array<A>) => as is [];
/**
 ...
 * @since 2.11.0
 */
export declare const matchW: <B, A, C>(onEmpty: LazyArg<B>, onNonEmpty: (as: NonEmptyArray<A>) => C) => (as: Array<A>) => B | C;
/**
 ...
 * @since 2.11.0
 */
export declare const matchLeftW: <B, A, C>(onEmpty: LazyArg<B>, onNonEmpty: (head: A, tail: Array<A>) => C) => (as: Array<A>) => B | C;
/**
 * Takes an array, if the array is empty it returns the result of `onEmpty`, otherwise
 ...
 * @since 2.10.0
 */
export declare const matchLeft: <B, A>(onEmpty: LazyArg<B>, onNonEmpty: (head: A, tail: Array<A>) => B) => (as: Array<A>) => B;
/**
 ...
 * @since 2.0.0
 */
export declare const foldLeft: <A, B>(onEmpty: LazyArg<B>, onNonEmpty: (head: A, tail: Array<A>) => B) => (as: Array<A>) => B;
/**
 ...
 * @since 2.11.0
 */
export declare const matchRightW: <B, A, C>(onEmpty: LazyArg<B>, onNonEmpty: (init: Array<A>, last: A) => C) => (as: Array<A>) => B | C;
/**
 * Takes an array, if the array is empty it returns the result of `onEmpty`, otherwise
 ...
 * @since 2.10.0
 */
export declare const matchRight: <B, A>(onEmpty: LazyArg<B>, onNonEmpty: (init: Array<A>, last: A) => B) => (as: Array<A>) => B;
/**
 ...
 * @since 2.0.0
 */
export declare const foldRight: <A, B>(onEmpty: LazyArg<B>, onNonEmpty: (init: Array<A>, last: A) => B) => (as: Array<A>) => B;
/**
 ...
 * @since 2.7.0
 */
export declare const chainWithIndex: <A, B>(f: (i: number, a: A) => Array<B>) => (as: Array<A>) => Array<B>;
/**
 ...
 * @since 2.0.0
 */
export declare const scanLeft: <A, B>(b: B, f: (b: B, a: A) => B) => (as: Array<A>) => NonEmptyArray<B>;
/**
 ...
 * @since 2.0.0
 */
export declare const scanRight: <A, B>(b: B, f: (a: A, b: B) => B) => (as: Array<A>) => NonEmptyArray<B>;
/**
 ...
 * @since 2.10.0
 */
export declare const size: <A>(as: Array<A>) => number;
/**
 ...
 * @since 2.10.0
 */
export declare const prependAll: <A>(middle: A) => ((as: Array<A>) => Array<A>);
/**
 ...
 * @since 2.9.0
 */
export declare const intersperse: <A>(middle: A) => ((as: Array<A>) => Array<A>);
/**
 ...
 * @since 2.0.0
 */
export declare const chunksOf: (n: number) => (<A>(as: Array<A>) => Array<NonEmptyArray<A>>);
/**
 * @category lifting
 * @since 2.11.0
 */
export declare const fromOptionK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => Array<B>;
/**
 * `Array` comprehension.
 *
 * ```
 ...
 * @since 2.11.0
 */
export declare const concatW: <B>(second: Array<B>) => <A>(first: Array<A>) => Array<A | B>;
/**
 * @since 2.11.0
 */
 ...
 * @since 2.0.0
 */
export declare const partitionMapWithIndex: <A, B, C>(f: (i: number, a: A) => Either<B, C>) => (fa: Array<A>) => Separated<Array<B>, Array<C>>;
/**
 ...
 * @since 2.9.0
 */
export declare const altW: <B>(that: LazyArg<Array<B>>) => <A>(fa: Array<A>) => Array<A | B>;
/**
 ...
 * @since 2.6.6
 */
export declare const unfold: <A, B>(b: B, f: (b: B) => Option<readonly [A, B]>) => Array<A>;
/**
 ...
 * @since 2.10.0
 */
export declare const getSemigroup: <A = never>() => Semigroup<Array<A>>;
/**
 ...
 * @since 2.11.0
 */
export declare const getUnionSemigroup: <A>(E: Eq<A>) => Semigroup<Array<A>>;
/**
 ...
 * @since 2.11.0
 */
export declare const getUnionMonoid: <A>(E: Eq<A>) => Monoid<Array<A>>;
/**
 ...
 * @since 2.11.0
 */
export declare const getIntersectionSemigroup: <A>(E: Eq<A>) => Semigroup<Array<A>>;
/**
 ...
 * @since 2.11.0
 */
export declare const getDifferenceMagma: <A>(E: Eq<A>) => Magma<Array<A>>;
/**
 * @category instances
 * @since 2.7.0
 */
 ...
 * @since 2.11.0
 */
export declare const fromEitherK: <E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Either<E, B>) => (...a: A) => Array<B>;
/**
 * @category unsafe
 * @since 2.0.0
 */
 ...
 * @since 2.9.0
 */
export declare const some: <A>(predicate: Predicate<A>) => (as: Array<A>) => as is NonEmptyArray<A>;
/**
 * Alias of [`some`](#some)
 *
 * @since 2.11.0
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => (fa: A[]) => { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }[];
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @deprecated
 */
export declare const prependToAll: <A>(middle: A) => ((as: Array<A>) => Array<A>);
/**
