 ...
 * @since 2.11.0
 */
export declare const matchW: <B, A, C>(onEmpty: LazyArg<B>, onNonEmpty: (as: ReadonlyNonEmptyArray<A>) => C) => (as: ReadonlyArray<A>) => B | C;
/**
 * @category pattern matching
 * @since 2.11.0
 */
export declare const match: <B, A>(onEmpty: LazyArg<B>, onNonEmpty: (as: ReadonlyNonEmptyArray<A>) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.11.0
 */
export declare const matchLeftW: <B, A, C>(onEmpty: LazyArg<B>, onNonEmpty: (head: A, tail: ReadonlyArray<A>) => C) => (as: ReadonlyArray<A>) => B | C;
/**
 ...
 * @since 2.10.0
 */
export declare const matchLeft: <B, A>(onEmpty: LazyArg<B>, onNonEmpty: (head: A, tail: ReadonlyArray<A>) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.5.0
 */
export declare const foldLeft: <A, B>(onEmpty: LazyArg<B>, onNonEmpty: (head: A, tail: ReadonlyArray<A>) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.11.0
 */
export declare const matchRightW: <B, A, C>(onEmpty: LazyArg<B>, onNonEmpty: (init: ReadonlyArray<A>, last: A) => C) => (as: ReadonlyArray<A>) => B | C;
/**
 ...
 * @since 2.10.0
 */
export declare const matchRight: <B, A>(onEmpty: LazyArg<B>, onNonEmpty: (init: ReadonlyArray<A>, last: A) => B) => (as: ReadonlyArray<A>) => B;
/**
 ...
 * @since 2.5.0
 */
export declare const foldRight: <A, B>(onEmpty: LazyArg<B>, onNonEmpty: (init: ReadonlyArray<A>, last: A) => B) => (as: ReadonlyArray<A>) => B;
/**
 * @category sequencing
 * @since 2.7.0
 */
export declare const chainWithIndex: <A, B>(f: (i: number, a: A) => ReadonlyArray<B>) => (as: ReadonlyArray<A>) => ReadonlyArray<B>;
/**
 ...
 * @since 2.5.0
 */
export declare const chop: <A, B>(f: (as: ReadonlyNonEmptyArray<A>) => readonly [B, ReadonlyArray<A>]) => ((as: ReadonlyArray<A>) => ReadonlyArray<B>);
/**
 ...
 * @since 2.11.0
 */
export declare const fromOptionK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => ReadonlyArray<B>;
/**
 ...
 * @since 2.11.0
 */
export declare const chainRecBreadthFirst: <A, B>(f: (a: A) => ReadonlyArray<Either<A, B>>) => (a: A) => ReadonlyArray<B>;
/**
 * @category instances
 * @since 2.11.0
 */
 ...
 * @since 2.11.0
 */
export declare const fromEitherK: <E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Either<E, B>) => (...a: A) => ReadonlyArray<B>;
/**
 * @category unsafe
 * @since 2.5.0
 */
 ...
 * @since 2.11.0
 */
export declare const exists: <A>(predicate: Predicate<A>) => (as: ReadonlyArray<A>) => as is RNEA.ReadonlyNonEmptyArray<A>;
/**
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => (fa: readonly A[]) => readonly { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }[];
export { 
/**
 * @category do notation
 * @since 2.13.0
