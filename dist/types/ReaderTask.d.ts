 ...
 * @since 2.16.10
 */
export declare const apFirstW: <R2, B>(second: ReaderTask<R2, B>) => <R1, A>(first: ReaderTask<R1, A>) => ReaderTask<R1 & R2, A>;
/**
 ...
 * @since 2.16.10
 */
export declare const apSecondW: <R2, B>(second: ReaderTask<R2, B>) => <R1, A>(first: ReaderTask<R1, A>) => ReaderTask<R1 & R2, B>;
/**
 * Runs computations in parallel.
 *
 * @category instances
 ...
 * @since 2.4.0
 */
export declare const fromIOK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => IO<B>) => <R = unknown>(...a: A) => ReaderTask<R, B>;
/**
 * Alias of `flatMapIO`.
 *
 * @category legacy
 ...
 * @since 2.11.0
 */
export declare const fromReaderK: <A extends ReadonlyArray<unknown>, R, B>(f: (...a: A) => R.Reader<R, B>) => (...a: A) => ReaderTask<R, B>;
/**
 ...
 * @since 2.13.0
 */
export declare const fromReaderIOK: <A extends ReadonlyArray<unknown>, R, B>(f: (...a: A) => ReaderIO<R, B>) => ((...a: A) => ReaderTask<R, B>);
/**
 ...
 * @since 2.13.0
 */
export declare const chainReaderIOKW: <A, R2, B>(f: (a: A) => ReaderIO<R2, B>) => <R1>(ma: ReaderTask<R1, A>) => ReaderTask<R1 & R2, B>;
/**
 * Alias of `flatMapReaderIO`.
 *
 * @category legacy
 * @since 2.13.0
 */
export declare const chainReaderIOK: <A, R, B>(f: (a: A) => ReaderIO<R, B>) => (ma: ReaderTask<R, A>) => ReaderTask<R, B>;
/**
 ...
 * @since 2.13.0
 */
export declare const chainFirstReaderIOKW: <A, R2, B>(f: (a: A) => ReaderIO<R2, B>) => <R1>(ma: ReaderTask<R1, A>) => ReaderTask<R1 & R2, A>;
/**
 * Alias of `tapReaderIO`.
 *
 * @category legacy
 * @since 2.13.0
 */
export declare const chainFirstReaderIOK: <A, R, B>(f: (a: A) => ReaderIO<R, B>) => (ma: ReaderTask<R, A>) => ReaderTask<R, A>;
/**
 * @category lifting
 * @since 2.4.0
 */
export declare const fromTaskK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => T.Task<B>) => <R = unknown>(...a: A) => ReaderTask<R, B>;
/**
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => <E>(fa: ReaderTask<E, A>) => ReaderTask<E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, R, B>(f: (index: number, a: A) => ReaderTask<R, B>) => ((as: ReadonlyArray<A>) => ReaderTask<R, ReadonlyArray<B>>);
/**
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndexSeq: <R, A, B>(f: (index: number, a: A) => ReaderTask<R, B>) => ((as: ReadonlyArray<A>) => ReaderTask<R, ReadonlyArray<B>>);
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(Applicative)`.
 *
 * @category traversing
 ...
 * @since 2.9.0
 */
export declare const traverseArray: <R, A, B>(f: (a: A) => ReaderTask<R, B>) => ((as: ReadonlyArray<A>) => ReaderTask<R, ReadonlyArray<B>>);
/**
 ...
 * @since 2.10.0
 */
export declare const traverseSeqArray: <R, A, B>(f: (a: A) => ReaderTask<R, B>) => ((as: ReadonlyArray<A>) => ReaderTask<R, ReadonlyArray<B>>);
/**
 * Alias of `flatMap`.
 *
 * @category legacy
 ...
 * @since 2.3.0
 */
export declare const chainFirst: <A, R, B>(f: (a: A) => ReaderTask<R, B>) => (first: ReaderTask<R, A>) => ReaderTask<R, A>;
/**
 * Alias of `tap`.
 *
 * @category legacy
