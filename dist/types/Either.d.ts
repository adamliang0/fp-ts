 ...
 * @since 2.10.0
 */
export declare const fromOptionK: <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => Either<E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.11.0
 */
export declare const chainOptionK: <E>(onNone: LazyArg<E>) => <A, B>(f: (a: A) => Option<B>) => (ma: Either<E, A>) => Either<E, B>;
/**
 * Use `flatMapOption`.
 *
 * @category legacy
 * @since 2.13.2
 */
export declare const chainOptionKW: <E2>(onNone: LazyArg<E2>) => <A, B>(f: (a: A) => Option<B>) => <E1>(ma: Either<E1, A>) => Either<E1 | E2, B>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftNullable: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => B | null | undefined, onNullable: (...a: A) => E) => (...a: A) => Either<E, NonNullable<B>>;
/**
 * @category lifting
 * @since 2.15.0
 */
export declare const liftOption: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => Option<B>, onNone: (...a: A) => E) => (...a: A) => Either<E, B>;
/**
 * @category sequencing
 * @since 2.15.0
 */
 ...
 * @since 2.10.0
 */
export declare const orElseW: <E1, E2, B>(onLeft: (e: E1) => Either<E2, B>) => <A>(ma: Either<E1, A>) => Either<E2, A | B>;
/**
 ...
 * @since 2.10.0
 */
export declare const tryCatchK: <A extends ReadonlyArray<unknown>, B, E>(f: (...a: A) => B, onThrow: (error: unknown) => E) => ((...a: A) => Either<E, B>);
/**
 * Use `liftNullable`.
 *
 * @category legacy
 * @since 2.9.0
 */
export declare const fromNullableK: <E>(e: E) => (<A extends ReadonlyArray<unknown>, B>(f: (...a: A) => B | null | undefined) => (...a: A) => Either<E, NonNullable<B>>);
/**
 * Use `flatMapNullable`.
 *
 * @category legacy
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => <E>(fa: Either<E, A>) => Either<E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, E, B>(f: (index: number, a: A) => Either<E, B>) => ((as: ReadonlyArray<A>) => Either<E, ReadonlyArray<B>>);
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(Applicative)`.
 *
 * @category traversing
 ...
 * @since 2.9.0
 */
export declare const traverseArray: <E, A, B>(f: (a: A) => Either<E, B>) => ((as: ReadonlyArray<A>) => Either<E, ReadonlyArray<B>>);
/**
