 ...
 * @since 2.10.0
 */
export declare const foldW: <B, C, A>(onNone: () => Task<B>, onSome: (a: A) => Task<C>) => (ma: TaskOption<A>) => Task<B | C>;
/**
 ...
 * @since 2.10.0
 */
export declare const tryCatchK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Promise<B>) => ((...a: A) => TaskOption<B>);
/**
 * @category lifting
 * @since 2.10.0
 */
 ...
 * @since 2.12.0
 */
export declare const fromEitherK: <E, A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Either<E, B>) => (...a: A) => TaskOption<B>;
/**
 * @category sequencing
 * @since 2.12.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromTaskK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => T.Task<B>) => (...a: A) => TaskOption<B>;
/**
...
declare const let_: <N extends string, A, B>(name: Exclude<N, keyof A>, f: (a: A) => B) => (fa: TaskOption<A>) => TaskOption<{ readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
export { 
/**
 * @category do notation
 * @since 2.13.0
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, B>(f: (index: number, a: A) => TaskOption<B>) => ((as: ReadonlyArray<A>) => TaskOption<ReadonlyArray<B>>);
/**
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndexSeq: <A, B>(f: (index: number, a: A) => TaskOption<B>) => ((as: ReadonlyArray<A>) => TaskOption<ReadonlyArray<B>>);
/**
