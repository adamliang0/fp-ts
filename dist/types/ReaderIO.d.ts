 ...
 * @since 2.13.0
 */
export declare const apW: <R2, A>(fa: ReaderIO<R2, A>) => <R1, B>(fab: ReaderIO<R1, (a: A) => B>) => ReaderIO<R1 & R2, B>;
/**
 * @category constructors
 * @since 2.13.0
 */
 ...
 * @since 2.13.0
 */
export declare const fromIOK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => I.IO<B>) => <R = unknown>(...a: A) => ReaderIO<R, B>;
/**
 * Alias of `flatMapIO`.
 *
 * @category legacy
 ...
 * @since 2.13.0
 */
export declare const fromReaderK: <A extends ReadonlyArray<unknown>, R, B>(f: (...a: A) => R.Reader<R, B>) => (...a: A) => ReaderIO<R, B>;
/**
 ...
 * @since 2.13.0
 */
export declare const chainReaderKW: <A, R1, B>(f: (a: A) => R.Reader<R1, B>) => <R2>(ma: ReaderIO<R2, A>) => ReaderIO<R1 & R2, B>;
/**
 * Alias of `tapReader`.
 *
 * @category legacy
 ...
 * @since 2.13.0
 */
export declare const chainFirstReaderKW: <A, R1, B>(f: (a: A) => R.Reader<R1, B>) => <R2>(ma: ReaderIO<R2, A>) => ReaderIO<R1 & R2, A>;
/**
 ...
 * @since 2.13.0
 */
export declare const bindTo: <N extends string>(name: N) => <E, A>(fa: ReaderIO<E, A>) => ReaderIO<E, { readonly [K in N]: A; }>;
/**
 * @category do notation
 * @since 2.13.0
 */
export declare const bind: <N extends string, A, E, B>(name: Exclude<N, keyof A>, f: (a: A) => ReaderIO<E, B>) => (ma: ReaderIO<E, A>) => ReaderIO<E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
/**
 * The `W` suffix (short for **W**idening) means that the environment types will be merged.
 *
 * @category do notation
 * @since 2.13.0
 */
export declare const bindW: <N extends string, A, R2, B>(name: Exclude<N, keyof A>, f: (a: A) => ReaderIO<R2, B>) => <R1>(fa: ReaderIO<R1, A>) => ReaderIO<R1 & R2, {
 ...
 * @since 2.13.0
 */
export declare const apS: <N extends string, A, E, B>(name: Exclude<N, keyof A>, fb: ReaderIO<E, B>) => (fa: ReaderIO<E, A>) => ReaderIO<E, { readonly [K in N | keyof A]: K extends keyof A ? A[K] : B; }>;
/**
 ...
 * @since 2.13.0
 */
export declare const apSW: <N extends string, A, R2, B>(name: Exclude<N, keyof A>, fb: ReaderIO<R2, B>) => <R1>(fa: ReaderIO<R1, A>) => ReaderIO<R1 & R2, {
    readonly [K in keyof A | N]: K extends keyof A ? A[K] : B;
}>;
/**
 * @since 2.13.0
 ...
 * @since 2.13.0
 */
export declare const traverseReadonlyNonEmptyArrayWithIndex: <A, R, B>(f: (index: number, a: A) => ReaderIO<R, B>) => ((as: ReadonlyNonEmptyArray<A>) => ReaderIO<R, ReadonlyNonEmptyArray<B>>);
/**
 ...
 * @since 2.13.0
 */
export declare const traverseReadonlyArrayWithIndex: <A, R, B>(f: (index: number, a: A) => ReaderIO<R, B>) => ((as: ReadonlyArray<A>) => ReaderIO<R, ReadonlyArray<B>>);
/**
 * Equivalent to `ReadonlyArray#traverseWithIndex(Applicative)`.
 *
 * @category traversing
 * @since 2.13.0
 */
export declare const traverseArrayWithIndex: <A, R, B>(f: (index: number, a: A) => ReaderIO<R, B>) => (as: ReadonlyArray<A>) => ReaderIO<R, ReadonlyArray<B>>;
/**
 ...
 * @since 2.13.0
 */
export declare const traverseArray: <A, R, B>(f: (a: A) => ReaderIO<R, B>) => ((as: ReadonlyArray<A>) => ReaderIO<R, ReadonlyArray<B>>);
/**
 ...
 * @since 2.13.0
 */
export declare const chainW: <A, R2, B>(f: (a: A) => ReaderIO<R2, B>) => <R1>(ma: ReaderIO<R1, A>) => ReaderIO<R1 & R2, B>;
/**
 * Alias of `tap`.
 *
 * @category legacy
 ...
 * @since 2.13.0
 */
export declare const chainFirstW: <A, R2, B>(f: (a: A) => ReaderIO<R2, B>) => <R1>(ma: ReaderIO<R1, A>) => ReaderIO<R1 & R2, A>;
