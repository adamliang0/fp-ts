 ...
 * @since 2.4.0
 */
export declare const fold: <E, B, A>(onLeft: (e: E) => Task<B>, onRight: (a: A) => Task<B>, onBoth: (e: E, a: A) => Task<B>) => (fa: TaskThese<E, A>) => Task<B>;
/**
 ...
 * @since 2.10.0
 */
export declare const foldW: <E, B, A, C, D>(onLeft: (e: E) => Task<B>, onRight: (a: A) => Task<C>, onBoth: (e: E, a: A) => Task<D>) => (fa: TaskThese<E, A>) => Task<B | C | D>;
/**
 * @since 2.4.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromOptionK: <E>(onNone: LazyArg<E>) => <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => Option<B>) => (...a: A) => TaskThese<E, B>;
/**
 * @category lifting
 * @since 2.10.0
 */
 ...
 * @since 2.11.0
 */
export declare const fromTheseK: <A extends ReadonlyArray<unknown>, E, B>(f: (...a: A) => TH.These<E, B>) => (...a: A) => TaskThese<E, B>;
/**
 * @category instances
 * @since 2.10.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromIOK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => IO<B>) => <E = never>(...a: A) => TaskThese<E, B>;
/**
 * @category instances
 * @since 2.10.0
 */
 ...
 * @since 2.10.0
 */
export declare const fromTaskK: <A extends ReadonlyArray<unknown>, B>(f: (...a: A) => T.Task<B>) => <E = never>(...a: A) => TaskThese<E, B>;
/**
 * @since 2.10.0
 */
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndex: <E>(S: Semigroup<E>) => <A, B>(f: (index: number, a: A) => TaskThese<E, B>) => ((as: ReadonlyArray<A>) => TaskThese<E, ReadonlyArray<B>>);
/**
 ...
 * @since 2.11.0
 */
export declare const traverseReadonlyArrayWithIndexSeq: <E>(S: Semigroup<E>) => <A, B>(f: (index: number, a: A) => TaskThese<E, B>) => ((as: ReadonlyArray<A>) => TaskThese<E, ReadonlyArray<B>>);
/**
