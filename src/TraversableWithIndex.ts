...
export interface TraversableWithIndex1<T extends URIS, I>
  extends FunctorWithIndex1<T, I>, FoldableWithIndex1<T, I>, Traversable1<T> {
...
export interface TraversableWithIndex2<T extends URIS2, I>
  extends FunctorWithIndex2<T, I>, FoldableWithIndex2<T, I>, Traversable2<T> {
...
export interface TraversableWithIndex2C<T extends URIS2, I, E>
  extends FunctorWithIndex2C<T, I, E>, FoldableWithIndex2C<T, I, E>, Traversable2C<T, E> {
